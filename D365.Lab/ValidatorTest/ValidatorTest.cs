...
namespace ValidatorTest
{
    ...
    public class ValidatorTest
    {
        ...
        [Test]
        [TestCase("09/25/2021")]
        public void IsDateTimeFormat_Valid_ShouldReturnTrue(string input)
        {
            bool result = input.IsDateTimeFormat("MM/dd/yyyy");
        ...
        {
            bool result = _validator.IsNoSymbolAfterAt(input, Config.BannedSymbolCheckAfterAt);
        ...
        [TestCase(".nodot")]
        [TestCase(",nodot")]
        public void IsEndingCommaAndDot_InValid_ShouldReturnFalse(string input)
        {
            bool result = _validator.IsEndingCommaAndDot(input);
        ...
        [TestCase("abc.")]
        [TestCase("abc,")]
        public void IsEndingCommaAndDot_Valid_ShouldReturnTrue(string input)
        {
            bool result = _validator.IsEndingCommaAndDot(input);
        ...
        {
            bool result = _validator.IsContainsNumber(input);
